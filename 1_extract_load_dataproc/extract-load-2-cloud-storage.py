...
def bucket_2_ext_tbl(project_id, table_name, root_path, client, time_substr):
...
if __name__ == '__main__':
    ...
    table_name = args.table_name #f'{trip_substr}_tripdata'
    ...
    while start_dt <= end_dt:
        ...
        if parquet_not_downloaded(df):
            ...
            if 'yellow_tripdata_2009' in root_path:
                table_name_q1 = f'external_{table_name}_2009'
                table_name_q2 = f'{table_name}_2009'
                data_schema_dict = schema_yellow_dict2009
            elif 'yellow_tripdata_2010' in root_path:
                table_name_q1 = f'external_{table_name}_2010'
            ...
            # stageing data load
            bucket_2_ext_tbl(project_id, table_name, root_path, client, time_substr)
            # logging stats
