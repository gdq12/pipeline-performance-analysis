    ...
    create or replace table `pipeline-analysis-455005`.`nytaxi_core2`.`core2_dm_monthly_stats`
  ...
  (
    ...
    select pickup_location_id, dropoff_location_id, pickup_month, pickup_year, pickup_rush_hour_status, pickup_weekday_name, ratecode_id, payment_type, trip_type, hvfhs_license_number, avg_trip_distance, avg_trip_duration_min, fare_amount, tip_amount, total_amount, total_fees, passenger_count, num_public_holidays, num_trips, transformation_dt
    from (
