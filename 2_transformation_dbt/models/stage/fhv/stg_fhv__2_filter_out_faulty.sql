select 
    ...
    tbl.creation_dt, 
    tbl.clone_dt
from {{ ref('fhv__4_adds_columns') }} tbl
left join {{ ref('stg_fhv__1b_id_faulty_trips') }} ft1 on tbl.data_source = ft1.data_source 
                                                    and tbl.trip_id = ft1.trip_id
left join {{ ref('stg_fhv__1a_id_duplicate_records') }} ft2 on tbl.dispatching_base_number = ft2.dispatching_base_number
